...
void MainMenuState::initButtons()
{
	this->buttons["GAME_STATE"] = new Button(100.f, 100.f, 150.f, 50.f, 
		&this->font, "New Game", 
		sf::Color(70, 70, 70, 200), sf::Color(150, 150, 150, 255), sf::Color(20, 20, 20, 255));

	this->buttons["EXIT_STATE"] = new Button(100.f, 170.f, 150.f, 50.f,
		&this->font, "Quit", 
		sf::Color(100, 100, 100, 200), sf::Color(150, 150, 150, 255), sf::Color(20, 20, 20, 255));
}
